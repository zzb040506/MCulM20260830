...
# 雷达：D + J 双层
order_d, order_j = D_ORDER, J_ORDER
...
both = pd.DataFrame({
    "维度": order_d + order_j,
    "分值(0-1)": [row[c] for c in dc] + [row[c] for c in jc],
    "类别": ["场域D"]*8 + ["判断J"]*6
})
